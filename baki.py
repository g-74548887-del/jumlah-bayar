    ...
    if baki < 0:
        ...
        def kira_kombinasi(baki, jenis=1):
            ...
            if jenis == 2:
                ...
                nilai = [5000, 2000, 1000, 500, 200, 100, 50]
            for n in nilai:
                if baki_sen >= n:
                    bil = baki_sen // n
                    baki_sen %= n
        ...
        # --- Papar 3 kemungkinan dalam kotak berasingan ---
                ...
                if bil > 0 and nilai in duit_images:
                    ...
                    if os.path.exists(img_path):
                        with cols[i % 4]:
                            ...
                            st.markdown(f"<div class='kuantiti'>{bil} keping/syiling</div>", unsafe_allow_html=True)
                    else:
